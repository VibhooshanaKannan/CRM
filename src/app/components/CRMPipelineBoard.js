  ...
  const pipelineStages = [
    {
      ...
      leads: [
        ...
        },
        {
          ...
          description:
            "Lead attraction and automation for small business owners",
          date: "No due date",
          messages: 4,
          calls: 7,
        },
      ...
      leads: [
        {
          ...
          description:
            "Cloud services for data storage and processing for businesses",
          date: "24 Mar",
          messages: 2,
          calls: 1,
        },
        ...
        },
        {
          ...
          description:
            "Innovative financial technologies and digital payment systems",
          date: "30 Mar",
          messages: 4,
          calls: 7,
        },
      ...
      {pipelineStages.map((stage, stageIndex) => (
        <div
          ...
          className={`pipeline-column ${
            stage.name === "Deal Closed" ? "deal-closed-column" : ""
          }`}
        >
          ...
          <div className="leads-container">
            {stage.leads.map((lead, leadIndex) => (
              <div
                key={leadIndex}
                className={`lead-card ${
                  lead.companyName === "Prime Estate" ? "dark-card" : ""
                }`}
              >
                ...
                {lead.manager && (
                  <div className="manager-info">
                    <div className="avatar">{lead.manager.name.charAt(0)}</div>
                ...
                <div className="card-footer">
                  {lead.date && (
                    <div className="meta-info date-box">
                      <svg
                        width="16"
                        height="16"
                        viewBox="0 0 24 24"
